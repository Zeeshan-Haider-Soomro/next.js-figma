...
const Banner1 = () => {
  return (
    ...
    <div className="row flex-lg-row-reverse align-items-center g-5 py-5">
      <div className="col-10 col-sm-8 col-lg-6">
        <Image src="/images/Image (7).png" className="d-block mx-lg-auto img-fluid" alt="Bootstrap Themes" width="700" height="500" loading="lazy"/>
      </div>
    ...
    <div className="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-1 g-4 py-5">
      <div className="col d-flex align-items-start">
        ...
        <Image src="/images/Group 7.png" className="bi text-body-secondary flex-shrink-0 me-3" alt="" width={47} height={48}/>
        <div> 
      ...
      <div className="col d-flex align-items-start">
        ...
        <Image src="/images/Group 12.png" className="bi text-body-secondary flex-shrink-0 me-3" alt="" width={47} height={48}/>
        <div>
      ...
      <div className="col d-flex align-items-start">
        ...
        <Image src="/images/Group 11.png" className="bi text-body-secondary flex-shrink-0 me-3" alt="" width={47} height={48}/>
        <div>
  ...
  <div className="container col-xxl-8 px-4 py-5">
    <div className="row flex-lg-row-reverse align-items-center g-5 py-5">
      <div className="col-10 col-sm-8 col-lg-6">
        <Image src="/images/Group 64.png" className="d-block mx-lg-auto img-fluid" alt="Bootstrap Themes" width="700" height="500" loading="lazy"/>
      </div>
      <div className="col-lg-6">
...
<div className="d-grid gap-2 d-md-flex justify-content-md-start" >
                <Image src="/images/Group 61.png" className="img-fluid"  alt="CTA" width={87} height={12} />
            </div>
...
<div className="flex justify-center">
    <Image src="/images/logos (1).png" alt="" width={1073} height={162}/>
</div>
...
<Image src="/images/arrow.png"  alt="" width={70} height={70}/>
</div>
    ...
    <Image src="/images/Group 46.png"  alt="" width={21} height={18} /><input type="text" placeholder="Your Email"></input>
